    ...
    try {
      ...
      if (dietolog) {
        await Message.addMessage({
          ...
          toUserId: userId,
          text:
            'Здравия желаю! С сегодняшнего дня я являюсь вашим персональным диетологом! В списке ваших сообщений есть беседа "Общий чат с диетологом", где вы можете задавать любые вопросы. \n Я в сети ежедневно с 20 до 21ч по Москве. Если у вас есть вопрос тет-а-тет, вы можете задать его здесь, в личных сообщениях. \n Рекомендую также отправлять отчеты по питанию в разделе "персональное меню", я буду их просматривать!'
        })
